...
public class TimePoint implements Comparable<TimePoint> {
    ...
    public int compareTo(TimePoint timePoint) {
        float thisTime = this.amount * this.timeUnit.getNanos();
        float otherTime = timePoint.amount * timePoint.timeUnit.getNanos();
    ...
    public TimePoint convert(TimeUnit timeUnit) {
        float amountInTargetUnit = this.amount
                * (this.timeUnit.getNanos() / (float) timeUnit.getNanos());
    ...
    /**
     * 
     * This is boilerplate equality method which can be generated by the IDE.
     * But I wrote it myself to following good coding style :)
     * 
     */
    @Override
